# Warren Microsite: September Debate

This is a static application which uses Gatsby and the open source Netlify CMS platform to make an easily templatable static site.

## Setting Up Gatsby


## Core Elements
- 1-2 pages of a little content/video/imagery;
  - Use content from campaign site as placeholder
- signup form
  - [ ] url to submit form at?
- donate button
  - Direct to campaign's ActBlue

** Below is original README from the `gatsby-netlify-cms` Gatsby boilerplate **
